function [u, v, w, t] = Probe_rkSolver(param, ~, tNoForceEnd, tAppliedForce, tAfterForceOff, tauF, Fo, geom, row, col, h, Fst)
    ...
    parfor j=1:row
        ...
        [~, func, l1, l2] = geometry_NL(phi_o, la1_o, la2_o, param.theta12, param.theta23);
        ...
        for i = 1:col
            ...
            K1 = (-K_GS_1*((l1_1-l1_o-d1*Po1_1)*((l1_gs-(y(i)-la1_o))...
                      *sin(a3_1)+r_1*cos(a3_1)))-K_GS_2*((l2_1-l2_o...
                      ...
                      +b_12*sin(a2_1-a6_1)))-K_SP_1*(a1_1-a1_o)...
                      -K_SP_2*(a2_1-a2_o)*e1_1-K_SP_3*(a5_1-a5_o)*e7_1-K_P*geom.r_CA^2*sin(2*x(i))/2 ...
            ...
            K2 = (-K_GS_1*((l1_2-l1_o-d1*Po1_2)*((l1_gs-(y(i)+h*L1/2-la1_o))...
                      *sin(a3_2)+r_1*cos(a3_2)))-K_GS_2*((l2_2-l2_o...
                      ...
                      +b_12*sin(a2_2-a6_2)))-K_SP_1*(a1_2-a1_o)...
                      -K_SP_2*(a2_2-a2_o)*e1_2-K_SP_3*(a5_2-a5_o)*e7_2-K_P*geom.r_CA^2*sin(2*(x(i)+h*K1/2))/2 ...
            ...
            K3 = (-K_GS_1*((l1_3-l1_o-d1*Po1_3)*((l1_gs-(y(i)+h*L2/2-la1_o))...
                      *sin(a3_3)+r_1*cos(a3_3)))-K_GS_2*((l2_3-l2_o...
                      ...
                      +b_12*sin(a2_3-a6_3)))-K_SP_1*(a1_3-a1_o)...
                      -K_SP_2*(a2_3-a2_o)*e1_3-K_SP_3*(a5_3-a5_o)*e7_3-K_P*geom.r_CA^2*sin(2*(x(i)+h*K2/2))/2 ...
            ...
            K4 = (-K_GS_1*((l1_4-l1_o-d1*Po1_4)*((l1_gs-(y(i)+h*L3-la1_o))...
                      *sin(a3_4)+r_1*cos(a3_4)))-K_GS_2*((l2_4-l2_o...
                      ...
                      +b_12*sin(a2_4-a6_4)))-K_SP_1*(a1_4-a1_o)...
                      -K_SP_2*(a2_4-a2_o)*e1_4-K_SP_3*(a5_4-a5_o)*e7_4-K_P*geom.r_CA^2*sin(2*(x(i)+h*K3))/2 ...
